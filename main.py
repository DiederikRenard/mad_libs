...
{noun2}: 'Well, it's not every day that you see a {adjective1} {noun1} {verb1}ing in the middle of the day.'
...
And so it was that {noun1} and {noun2} went off to {verb2} and they had a great time.
The End.
"""
